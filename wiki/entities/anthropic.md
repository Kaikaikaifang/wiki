...
根据 [[sources/building-effective-ai-agents]]、[[sources/how-we-built-our-multi-agent-research-system]] 与 [[sources/scaling-managed-agents-decoupling-the-brain-from-the-hands]]，Anthropic 对 agent 的立场有几个鲜明特点。我之所以愿意把这几篇文章反复串起来看，就是因为它们确实构成了一套相对一致的方法论：
