...
如果整本书只能记一句话，我大概就记这一章。因为它真正改变的不是某个索引技巧，而是“数据库性能到底该由谁负责”这个责任分配。
...
这一章的价值不在技术细节，而在责任重分配：**SQL 性能不是“数据库后来帮你优化”的问题，而是“查询一开始是不是给数据库设计了正确访问路径”的问题。** 我觉得这也是整套索引材料最值得反复回看的起点。
