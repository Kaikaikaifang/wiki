...
这段官方文档对我最有价值的地方，是它把“能不能转”这个问题从口头争论变成了有明确路径的工程事实。但它也同样明确地告诉我，这件事虽然受支持，却绝不是一次可以随手完成的轻量改动。
...
这让我更愿意把“从非复制表转成复制表”视为一类**迁移工程**，而不是一类 schema 改动。因为它牵涉的不只是引擎名字变化，而是底层元数据路径、数据一致性和恢复语义。我觉得这正是这类文档最该被记住的地方：官方说“支持”，不等于官方在说“轻松”。
