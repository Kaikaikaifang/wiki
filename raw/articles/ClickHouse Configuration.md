...
source: https://clickhouse.com/docs/integrations/language-clients/go/configuration#connecting-to-multiple-nodes
author:
published:
created: 2026-05-13
...
| `Settings` | `Settings` | — | Map of ClickHouse settings applied to every query. Individual queries can override via [context](https://clickhouse.com/docs/integrations/language-clients/go/clickhouse-api#using-context). |
...
Additional compression techniques are available when using HTTP transport: `gzip`, `deflate`, and `br`. See [Database/SQL API - Compression](https://clickhouse.com/docs/integrations/language-clients/go/database-sql-api#compression) for details.
