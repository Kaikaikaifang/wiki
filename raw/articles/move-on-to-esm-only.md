...
source: "https://antfu.me/posts/move-on-to-esm-only"
author:
  - "[[Anthony Fu]]"
published:
created: 2026-04-28
...
Shipping dual formats essentially doubles the package size, as both CJS and ESM bundles need to be included. While a few extra kilobytes might not seem significant for a single package, the overhead can quickly add up in projects with hundreds of dependencies, leading to the infamous node\_modules bloat. Therefore, package authors should keep an eye on their package size. Moving to ESM-only is a way to optimize it, especially if the package doesn’t have strong requirements on CJS.
...
![](https://antfu.me/images/node-modules-inspector-1.png)

Node Modules Inspector - Overview

![](https://antfu.me/images/node-modules-inspector-2.png)

Node Modules Inspector - Dependency Graph

![](https://antfu.me/images/node-modules-inspector-3.png)

Node Modules Inspector - Reports like ESM Adoptions and Duplicated Packages
...
To learn more about how to use it and inspect your projects, check the repository [node-modules-inspector](https://github.com/antfu/node-modules-inspector).
